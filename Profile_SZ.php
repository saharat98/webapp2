...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="Profile_SZ.css">
...
<body>
            ...
            <div class="container">
                ...
                <div class="nav-grid">
                    ...
                    <ul class="menu">
                        ...
                        <li><a class="Page_Active" href="Profile_SZ.php">Profile</a></li>
                    </ul>
                </div>
            </div>
            <!-- END NAV GRID -->
    ...
    <section class="content">
        <div class="container">
            ...
            <div class="content-Register">
                <div class="content-Register-grid">
                    <div class="content-Register-items">
    ...
    <button type="button" class="btn btn-primary btn-lg">SAVE</button>                    </div>
                </div>
            </div>
            <!-- content-Register -->
